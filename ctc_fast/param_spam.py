...
PARAM_SETTING_LIST = [
    ...
    #{'layerSize': 1824, 'inputDim': 21*13, 'rawDim': 21*13, 'run_desc': 'mfcc_context', 'dataDir': TRAIN_DATA_DIR['mfcc'], 'reg': 1.0},
    #{'layerSize': 1824, 'inputDim': 21*13, 'rawDim': 21*13, 'run_desc': 'mfcc_context', 'dataDir': TRAIN_DATA_DIR['mfcc'], 'reg': 0.1},
    {'layerSize': 1824, 'inputDim': 21*13, 'rawDim': 21*13, 'run_desc': 'mfcc_context', 'dataDir': TRAIN_DATA_DIR['mfcc'], 'reg': 0.01},
    {'layerSize': 1824, 'inputDim': 21*13, 'rawDim': 21*13, 'run_desc': 'mfcc_context', 'dataDir': TRAIN_DATA_DIR['mfcc'], 'reg': 0.001},
    {'layerSize': 1824, 'inputDim': 21*13, 'rawDim': 21*13, 'run_desc': 'mfcc_context', 'dataDir': TRAIN_DATA_DIR['mfcc'], 'reg': 0.0001},
