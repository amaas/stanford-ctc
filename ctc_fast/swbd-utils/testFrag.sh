...
# Manually merge since gmm has no split character file
python convert_to_ctm.py frag
./score_sclite_frag.sh sclite_score_frag fraghyp.ctm
grep Sum sclite_score_frag/eval2000.ctm.filt.sys | /scail/group/deeplearning/speech/zxie/kaldi-stanford/kaldi-trunk/egs/swbd/s5b/utils/best_wer.sh
