...
python convert_to_ctm.py oov
./score_sclite_oov.sh sclite_score_oov oovhyp.ctm
grep Sum sclite_score_oov/eval2000.ctm.filt.sys | /scail/group/deeplearning/speech/zxie/kaldi-stanford/kaldi-trunk/egs/swbd/s5b/utils/best_wer.sh
